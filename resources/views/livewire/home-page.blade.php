...
<div class="w-full h-screen bg-gradient-to-r from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
      <div>
        <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your journey with <span class="text-blue-600">Buy Or Die</span></h1>
...
<section class="py-20">
  <div class="max-w-xl mx-auto">
    <div class="text-center ">
      ...
      Learn more about the top brands that guarantee quality and reliability. Our selection includes a diverse range of global and local brands, all in one place.
      </p>
    </div>
  </div>
...
<div class="bg-orange-200 py-20">
  <div class="max-w-xl mx-auto">
    <div class="text-center ">
      ...
      <p class="mb-12 text-base text-center text-gray-500">
      Explore a wide range of categories that cater to all your needs, from electronics to personal care products. Each category is thoughtfully curated to meet your expectations and provide you with the best shopping experience.
      </p>
    </div>
  </div>
